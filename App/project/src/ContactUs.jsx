...
const ContactUs = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://justiceai.up.railway.app", {
        method: "POST",
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-black text-white px-8 py-16 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* Email */}
          <div className="backdrop-blur-lg bg-white/10 p-8 rounded-2xl border border-white/20 shadow-xl h-fit">
            <h2 className="text-2xl font-semibold mb-4 text-blue-300">Contact Information</h2>
            <p className="text-gray-300 mb-8">
              Reach us by email for inquiries and support.
            </p>
