...
const AboutUs = () => {
  ...
  const faqs = [
    {
      question: "What is JusticeAI?",
      answer:
        "JusticeAI is India's advanced AI-powered legal assistant, designed to make legal knowledge accessible to everyone, free of cost. With cutting-edge AI technology, JusticeAI helps individuals understand complex legal matters effortlessly, ensuring that legal guidance is just a conversation away. JusticeAI offers multilingual support, making legal assistance available in multiple Indian languages to bridge the gap between legal knowledge and the people who need it most. Whether you seek insights into property disputes, criminal law, consumer rights, or any other legal domain, JusticeAI is here to guide you. Conceptualized and developed independently, JusticeAI is committed to providing accurate, AI-driven legal insights, empowering individuals with the knowledge to make informed decisions. Start your journey with JusticeAI today—explore legal information in your preferred language and take control of your rights with confidence!",
    },
    {
      question: "Do I need an account to use JusticeAI?",
      answer:
    ...
    {
      question: "Which languages does JusticeAI support?",
      answer:
    ...
    },
    {
      ...
      answer:
        "JusticeAI is designed to handle multiple queries seamlessly, and you can switch between various specialized chatbots as needed.",
    },
  ];
        ...
        >
          ...
          <div className="inline-block mb-6">
            <div className="h-20 w-20 rounded-full bg-gradient-to-br from-purple-600 to-blue-500 flex items-center justify-center mx-auto">
              <span className="text-white font-bold text-3xl">JA</span>
            </div>
          </div>
          <br></br>
          <br></br>
      ...
      <div className="container max-w-6xl mx-auto px-6 py-24">
        ...
        <Fade triggerOnce direction="up">
          <div className="text-center mb-24">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              JusticeAI leverages cutting-edge AI to make legal services simple, accessible, and efficient for everyone in India.
            </p>
          </div>
        </Fade>
        ...
        <Fade triggerOnce>
          <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl p-8 mb-24 relative overflow-hidden">
            ...
            <h2 className="text-3xl font-semibold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-blue-500 relative z-10">Why JusticeAI is Better</h2>
        ...
        <Fade triggerOnce>
          <div className="text-center backdrop-blur-md bg-gradient-to-r from-purple-900/30 to-blue-900/30 border border-white/10 rounded-2xl p-12 relative overflow-hidden">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto relative z-10">
              Join thousands of Indians who are simplifying their legal journey with JusticeAI's AI-powered assistance.
            </p>
